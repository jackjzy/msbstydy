 ...
 * =============================================================================
 */
package com.ruoyi.app.util.unionPay.acp.sdk;
...
public class SDKConfig {
	...
	public static final String FILE_NAME_PROD = "acp_sdk_prod.properties";

	public static final String UNIONPAY_ACTIVE = "UNIONPAY_ACTIVE";
	...
	/** 后台退款通知地址  */
	public static final String SDK_REFUNDBACKURL = "acpsdk.refundBackUrl";
	/** 前台通知地址  */
	...
	public  Boolean getActive()  {
		InputStream in = null;
		LogUtil.writeLog("从classpath: " +SDKConfig.class.getClassLoader().getResource("").getPath()+" 获取属性文件"+"application.yml");
		in = SDKConfig.class.getClassLoader().getResourceAsStream("application.yml");
			if (null != in) {
		...
		properties.getProperty(UNIONPAY_ACTIVE);
		if("prod".equalsIgnoreCase(properties.getProperty(UNIONPAY_ACTIVE)))return true;
		return false;
	}
	...
	public void loadPropertiesFromPath(String rootPath) {
		if (rootPath != null && !"".equals(rootPath.trim())) {
			Boolean active = SDKConfig.getConfig().getActive();
			String fileName=FILE_NAME;
			if(active){ fileName=FILE_NAME_PROD;}
			LogUtil.writeLog("从路径读取配置文件: " + rootPath+File.separator+fileName);
	...
	public void loadPropertiesFromSrc() {
		...
		try {
			...
			String fileName=FILE_NAME;
			if(active){ fileName=FILE_NAME_PROD;}
			LogUtil.writeLog("从classpath: " +SDKConfig.class.getClassLoader().getResource("").getPath()+" 获取属性文件"+fileName);
	...
	public void loadProperties(Properties pro) {
		...
		value = pro.getProperty(SDK_REFUNDBACKURL);
		if (!SDKUtil.isEmpty(value)) {
