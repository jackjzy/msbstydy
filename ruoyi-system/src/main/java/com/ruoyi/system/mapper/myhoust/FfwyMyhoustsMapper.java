package com.ruoyi.system.mapper.myhoust;
 ...
 * @date 2021-04-26
 */
public interface FfwyMyhoustsMapper 
{
    /**
     * 查询【请填写功能名称】
     * 
     ...
     * @return 【请填写功能名称】集合
     */
    public List<FfwyMyhousts> selectFfwyMyhoustsList(FfwyMyhousts ffwyMyhousts);
     ...
     * 批量删除【请填写功能名称】
     * 
     * @param myhoustIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteFfwyMyhoustsByIds(Long[] myhoustIds);

    List<FfwyWorkplanVo> selectFfwyMyhoustsByid(Long orderClientId);
