package com.ruoyi.common.utils.eqb.hz.constant;
...
//	public static final String host = "https://openapi.esign.cn";
	...
	// 项目Id(应用Id）
	public static final String PROJECT_ID = "7438864348";
	// 项目密钥(应用密钥）
	public static final String PROJECT_SECRET = "eae8591c5d6f9f3395e5ad377954aee7";
